...
constexpr uint32_t META_DATA_ENEMY_INDEX = META_DATA_HAND_INDEX + HAND_MAX_SIZE;
constexpr uint32_t META_DATA_ALLY_INDEX = META_DATA_ENEMY_INDEX + BOARD_CAPACITY_PER_SIDE;
